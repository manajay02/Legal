...
MONGO_TIMEOUT_MS = 2000  # 2 second timeout for MongoDB connection
...
class SimilarityEngine:
    ...
    def _init_mongo(self):
        ...
        try:
            ...
            print("[WARNING] Similarity search will work with text queries only (not filename lookups).")
            self._mongo_available = False
        ...
        *,
        ...
        if query_text is None:
            ...
            if not self._mongo_available:
                raise ValueError("MongoDB not available. Please provide 'text' instead of 'filename'.")
