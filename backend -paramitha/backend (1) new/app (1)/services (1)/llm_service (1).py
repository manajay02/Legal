...
REQUIRED JSON FORMAT — fill EVERY field; null only if truly absent:
{
  ...
  "sections": [
    {"title": "Header and Case Details", "text": "3-6 sentence summary of the header", "order_index": 1, "section_number": null, "page_start": null},
    {"title": "Case Overview / Background", "text": "3-6 sentence summary of the background", "order_index": 2, "section_number": null, "page_start": null},
    {"title": "Facts", "text": "3-6 sentence summary of key facts", "order_index": 3, "section_number": null, "page_start": null},
    {"title": "Legal Issues", "text": "3-6 sentence summary of legal issues", "order_index": 4, "section_number": null, "page_start": null},
    {"title": "Arguments", "text": "3-6 sentence summary of arguments", "order_index": 5, "section_number": null, "page_start": null},
    {"title": "Court Reasoning", "text": "3-6 sentence summary of court reasoning", "order_index": 6, "section_number": null, "page_start": null},
    {"title": "Decision and Orders", "text": "3-6 sentence summary of decision", "order_index": 7, "section_number": null, "page_start": null}
  ]
}

For section_number use the roman numeral or number heading if visible (e.g. 'I', 'II', '1'). For page_start use the page number where the section begins if identifiable from the text; otherwise use null."""
